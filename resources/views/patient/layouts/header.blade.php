        ...
        <nav class="navbar navbar-expand-lg header-nav">
            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    ...
                    <!--<li class="has-submenu">-->
                    <!--    <a >Admin <i class="fas fa-chevron-down"></i></a>-->
                    <!--    <ul class="submenu">-->
                    <!--        <li><a href="{{url('/admin')}}">Admin</a></li>-->
                    <!--        <li><a href="{{url('/pharmacy-dashboard')}}">Pharmacy Admin</a></li>-->
                    <!--         <li><a href="{{url('/allregister')}}">All Admin Register</a></li>-->
                    <!--         <li><a href="{{url('bloodbank/bloodbank-dashboard')}}">Bloodbank Admin </a></li>-->
                    <!--         <li><a href="pathology-dashboard.html">Pathology Admin </a></li>-->
                    <!--         <li><a href="diagnostic-dashboard.html">Diagnostic Admin </a></li>-->
                    <!--         <li><a href="hospital-dashboard.html">Hospital Admin </a></li>-->
                    <!--         <li><a href="clinic-dashboard.html">Clinic Admin </a></li>-->
                    <!--    </ul>-->
                    <!--</li>-->
                    <li class="login-link">
