    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            ...
            @endif
                        ...
                        @endif
                            <!-- Form -->
                            <form action="{{url('/hospitaladmin')}}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="text-center dont-have">Don’t have an account? <a href="{{url('/hospitalregister')}}">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
