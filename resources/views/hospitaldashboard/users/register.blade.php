...
<body>
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            <h1>Register For Hospital Dashboard</h1>
            ...
            @endif
                            <!-- Form -->
                            <form action="{{url('/hospitalregister')}}" enctype="multipart/form-data" method="post" multiform>
                            {{ csrf_field() }}
                                <div class="form-group">
                                <label for="bbname">Hospital Name</label>
                            ...
                            <div class="text-center dont-have">Already have an account? <a href="{{url('/bloodbankadmin')}}">Login</a></div>
                        </div>
                    </div>
                </div>
            </div>
