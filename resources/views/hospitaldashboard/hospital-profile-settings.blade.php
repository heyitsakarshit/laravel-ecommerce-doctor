...
@section('content')
<?php $hospital = DB::table('hospitalprofiles')->where(['email'=>Session::get('hospitalSession')])->get(); ?>
...
<body>
                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9">
                        ...
                        <!-- Basic Information -->
                        <form method="post" enctype="multipart/form-data" action="{{url('/hospital/hospital-profile-setting')}}">
    {{ csrf_field() }}
                        <div class="card">
            ...
            @endif
                                ...
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="change-avatar">
                                                ...
                                                @foreach($hospital as $hu)    
                                                    <img src="{{asset('/hospital/uploads/user_img/'.$hu->user_image)}}"  alt="Upload Image">
                                                ...
                                                @endforeach
                                                 ...
                                                 <div class="upload-img">
                                                    <div class="change-photo-btn">
                                                     ...
                                                     @foreach($hospital as $hu)
                                                        <input type="hidden" value="{{$hu->user_image}}" name="current_image1">
                                                        @endforeach
                                                    </div>
                                    ...
                                    @foreach($hospitaluser as $huser)
                                    <div class="col-md-6">
                                        <input type="hidden" name="userid" class="form-control" value="{{$huser->id}}">   
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Hospital Name<span class="text-danger">*</span></label>
                                            <input type="text" name="name" class="form-control" value="{{$huser->name}}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Email <span class="text-danger">*</span></label>
                                            <input type="email" name="email" value="{{$huser->email}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" value="{{$huser->phone}}" class="form-control" readonly>
                                        </div>
                                    </div>
                                    @endforeach
                                    <div class="col-md-6">
                                ...
                                <div class="row form-row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="hospital_image"  id="image"  class="upload" required>
                                            @foreach($hospital as $hu)
                                          
                                            <input type="hidden" value="{{$hu->hospital_image}}" id="image"  name="current_image2">
                                            @endforeach
                                        </div>
                                        <div class="upload-wrap">
                                            <div class="upload-images">
                                                @foreach($hospital as $hu)
                                                <img src="{{asset('/hospital/uploads/hospital_img/'.$hu->hospital_image)}}" id="img-tag"alt="Upload Image">
                            ...
                            <div class="card-body">
                                ...
                                <div class="registrations-info">
                                    <div class="row form-row reg-cont">
                                        <div class="col-12 col-md-5">
                                            <div class="form-group">
                                                <label>Hospital Registrations Number</label>
