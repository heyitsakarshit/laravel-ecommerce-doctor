...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="superadmin/assets//img/favicon.png">
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <img class="img-fluid" src="superadmin/assets/img/logo-white.png" alt="Logo">
                    </div>
            ...
            @endif
                            ...
                            <div class="text-center dont-have">Don’t have an account? @if (Route::has('register'))
