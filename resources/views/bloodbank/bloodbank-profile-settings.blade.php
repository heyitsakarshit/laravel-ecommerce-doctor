...
<body>
    ...
    <!-- Main Wrapper -->
                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bloodbank Info</h4>
                                <div class="row form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Bloodbank Address</label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Bloodbank Images</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group card-label">
                                                        ...
                                                        <input class="form-control" id="card_number" placeholder="1234  5678  9876  5432" type="number">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group card-label">
                                                        <label for="expiry_month">IFSC Code</label>
                                                        <input class="form-control" id="expiry_month" placeholder="ABCD1234" type="text">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group card-label">
                                ...
                                <h4 class="card-title">Subscriptions by</h4>
                                 ...
                                 <div class="col-12 col-md-6 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="AB12CD45FG56">
                                                    </div>
                                                </div>
