                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-auto">
                                <a class="btn btn-primary btn-sm" href="{{url('/admin/addblog')}}"><i class="fa fa-plus mr-1"></i> Add Blog</a>
                            </div>
                        </div>
                        ...
                        <div class="row blog-grid-row">
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col"><a href="{{url('/admin/editblog/'.$blog->id)}}" 
                                        class="text-success"><i class="fa fa-edit"></i> Edit</a></div>
                                        <div class="col text-right"><a href="{{url('/admin/blog/delete/'.$blog->id)}}" class="text-danger" ><i class="fa fa-trash-alt"></i>Delete</a></div>
                                    </div>
