        ...
        <div class="login-wrapper">
            <div class="container">
                <div class="loginbox">
                    <div class="login-left">
                        <img class="img-fluid" src="{{asset('superadmin/assets/img/logo-white.png')}}" alt="Logo">
                    </div>
            ...
            @endif
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <input class="form-control" name="password"  id="pswd1" type="password" placeholder="Password" required>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" name="password_confirmation" type="password" id="pswd2" placeholder="Confirm Password" required>
                                </div>
                            ...
                            <div class="text-center dont-have">Already have an account? <a href="{{ url('/admin')}}">Login</a></div>
                        </div>
                    </div>
                </div>
            </div>
