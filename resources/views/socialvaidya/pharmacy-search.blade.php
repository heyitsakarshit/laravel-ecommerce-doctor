                                    ...
                                    <div class="doc-info-left">
                                        <div class="doctor-img1">
                                            <a href="pharmacy-details.html">
                                                <img src="{{asset('assets/img/medical-img1.jpg')}}" class="img-fluid" alt="User Image">
                                            </a>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        <div class="doctor-img1">
                                            <a href="pharmacy-details.html">
                                                <img src="{{asset('assets/img/medical-img2.jpg')}}" class="img-fluid" alt="User Image">
                                            </a>
                                        </div>
                                        <div class="doc-info-cont">
                            ...
                            <div class="card-body">
                                <div class="doctor-widget">
                                    <div class="doc-info-left">
                                        <div class="doctor-img1">
                                            <a href="pharmacy-details.html">
                                                <img src="{{asset('assets/img/medical-img3.jpg')}}" class="img-fluid" alt="User Image">
                                            </a>
                                        </div>
                                        <div class="doc-info-cont">
