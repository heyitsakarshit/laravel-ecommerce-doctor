                        ...
                        <div class="col-12 d-flex">
                            <div class="slide-image col-12 col-lg-6">
                                ...
                                <div class="d-inline-block">
                                    <a href="{{url('/doctor-booking')}}" class="btn book-btn1" tabindex="0">Book Now</a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-10">
                        <div class="banner-wrapper2">
                            <div class="search-box1">
                                <form action="https://Social Vaidya-html.dreamguystech.com/template/pharmacy-search.html">
