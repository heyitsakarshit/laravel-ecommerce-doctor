                            ...
                            <div class="blog-view">
                                <div class="blog blog-single-post">
                                    <div class="blog-image">
                                        <a href="javascript:void(0);"><img alt="" src="{{asset('doctorprofile/uploads/blogimg/'.$blogdetails->image)}}" class="img-fluid"></a>
                                    </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="post-author">
                                                        <a href="{{url('/doctor-profile')}}"><img src="{{asset('assets/img/doctors/doctor-thumb-02.jpg')}}" alt="Post Author"> <span>Dr. Darren Elder</span></a>
                                                    </div>
                                                </li>
                                    ...
                                    <div class="about-author">
                                        <div class="about-author-img">
                                            <div class="author-img-wrap">
                                                <a href="{{url('/doctor-profile')}}"><img class="img-fluid rounded-circle" alt="" src="{{asset('assets/img/doctors/doctor-thumb-02.jpg')}}"></a>
                                            </div>
                                        </div>
                                ...
                                <div class="card blog-comments clearfix">
                                    ...
                                    <ul class="comments-list">
                                        <li>
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <img class="avatar" alt="" src="{{asset('assets/img/patients/patient4.jpg')}}">
                                                </div>
                                            ...
                                            <ul class="comments-list reply">
                                                ...
                                                <li>
                                                    <div class="comment">
                                                        <div class="comment-author">
                                                            <img class="avatar" alt="" src="{{asset('assets/img/patients/patient3.jpg')}}">
                                                        </div>
                                                        <div class="comment-block">
                                                            <span class="comment-by">
                                        ...
                                        <li>
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <img class="avatar" alt="" src="{{asset('assets/img/patients/patient6.jpg')}}">
                                                </div>
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                        ...
                                        <li>
                                            <div class="comment">
                                                <div class="comment-author">
                                                    <img class="avatar" alt="" src="{{asset('assets/img/patients/patient7.jpg')}}">
                                                </div>
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                ...
                                <div class="card-body">
                                    <ul class="latest-posts">
                                        <li>
                                            ...
                                            <div class="post-info">
                                                <h4>
                                                    <a href="{{url('blog-details')}}">Social Vaidya – Making your clinic painless visit?</a>
                                                </h4>
                                                <p>4 Dec 2019</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="post-thumb">
                                                <a href="{{url('blog-details')}}">
                                                    <img class="img-fluid" src="{{asset('assets/img/blog/blog-thumb-02.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info">
                                                <h4>
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <a href="{{url('blog-details')}}">
                                                    <img class="img-fluid" src="{{asset('assets/img/blog/blog-thumb-03.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info">
                                                <h4>
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <a href="{{url('blog-details')}}">
                                                    <img class="img-fluid" src="{{asset('assets/img/blog/blog-thumb-04.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info">
                                                <h4>
                                        ...
                                        <li>
                                            <div class="post-thumb">
                                                <a href="{{url('blog-details')}}">
                                                    <img class="img-fluid" src="{{asset('assets/img/blog/blog-thumb-05.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="post-info">
                                                <h4>
