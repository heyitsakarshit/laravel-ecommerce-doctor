                                                        ...
                                                        <div class="tab-content schedule-cont">
                                                            ...
                                                            <div id="slot_sunday" class="tab-pane fade">
                                                                <h4 class="card-title d-flex justify-content-between">
                                                                    ...
                                                                    <a class="edit-link"  href="{{url('/diagnostic/diagnostic-schedule-add-time')}}"><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                </h4>
                                                            ...
                                                            <div id="slot_monday" class="tab-pane fade show active">
                                                                <h4 class="card-title d-flex justify-content-between">
                                                                    <span>Time Slots</span>
                                                                    <a class="edit-link" href="{{url('/diagnostic/diagnostic-schedule-edit-time')}}"><i class="fa fa-edit mr-1"></i>Edit</a>
                                                                </h4>
                                                            ...
                                                            <div id="slot_tuesday" class="tab-pane fade">
                                                                <h4 class="card-title d-flex justify-content-between">
                                                                    <span>Time Slots</span>
                                                                    <a class="edit-link" data-toggle="modal" href="{{url('/diagnostic/diagnostic-schedule-add-time')}}"><i class="fa fa-plus-circle"></i> Add Slot</a>
                                                                </h4>
                                                                <p class="text-muted mb-0">Not Available</p>
                                                            </div>
                                                            <!-- /Tuesday Slot -->
