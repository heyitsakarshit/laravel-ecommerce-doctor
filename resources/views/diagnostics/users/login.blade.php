    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            <h1>Login to Diagnostics Dashboard</h1>
            ...
            @endif
                        ...
                        @endif
                            <!-- Form -->
                            <form action="{{url('/diagnosticadmin')}}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="text-center dont-have">Don’t have an account? <a href="{{url('/diagnosticregister')}}">Register</a></div>
                        </div>
                    </div>
                </div>
            </div>
